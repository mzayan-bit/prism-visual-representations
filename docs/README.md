...
Welcome to the comprehensive documentation suite for **PRISM (Probing the Evolution of Visual Representations)**.
...
- [Architecture Overview](architecture/overview.md): Monorepo design, module boundaries, system topology, and mathematical foundation.
